      ...
      <>
        ...
        <ul>
          <li>
            ...
            However, after a couple of months, having rewritten the entire
            system, our clients claimed that the appearance as well as the
            usability of the app had been drastically improved, more{' '}
            <em>'professional'</em> so to speak. Taking users' needs into
            account, the project is constently evolving.
          </li>
        </ul>
      </>
    ),
